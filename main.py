...
@app.get('/searchMods')
def searchModsAPI(gameId = 432, classId = None, gameVersion = None, searchFilter = None, sortField = None, sortOrder = None, modLoaderType = 4, gameVersionTypeId = None, slug = None, index = None, pageSize = None):
